; **************************************************************************************
; VDS-ECO-1 firmware ROM v1.1
; dump by Alessandro Liberalato
; disassembly by Antonino Porcino
; **************************************************************************************

; $0000-$07FF firmware ROM
; $1000-      video ram

0000: C3 20 00                   L0000: jp      BOOTM         ; Z80 CPU starts from here
0003: C3 E3 00                   L0003: jp      PUTCHAR       ; put character C to video
0006: C3 54 01                   L0006: jp      L0154
0009: C3 18 01                   L0009: jp      L0118
000C: C3 01 01                   L000C: jp      L0101
000F: C3 03 01                   L000F: jp      L0103
0012: C3 9F 01                   L0012: jp      PRINTSYSERR
0015: C3 F9 00                   L0015: jp      L00F9
0018: C3 C0 00                   L0018: jp      L00C0
001B: C3 D6 00                   L001B: jp      PRINTS_HL     ; print string in HL

                                 CRCVALUE:
001E: FF                                DB      0FFh    ; the checksum value for the
001F: FF                                DB      0FFh    ; firmware ROM $0000-$07FF

;***************************************************************************************
; MACHINE BOOT
;***************************************************************************************
0020: 31 00 18                   BOOTM: ld      sp,1800h   ; sets stack pointer

0023: 21 5C 03                          ld      hl,035Ch   ; copy from 035C-0371
0026: 11 D0 17                          ld      de,17D0h   ; to 17D0-17E5
0029: 01 15 00                          ld      bc,0015h   ;
002C: ED B0                             ldir               ;

002E: 3A 00 10                          ld      a,(1000h)  ; read from video RAM (?)
0031: 3E 80                             ld      a,80h      ;
0033: D3 00                             out     (00h),a    ; set bit 7 on port 00h (bank switching ?)

; CRC
; this routine sums in A the addresses from 0000-07FF
; and subtracts with two bytes at (CRCVALUE)
; if the result is not zero then CRC ERR message is displayed
...
003A: 23                                inc     hl
003B: 47                                ld      b,a
003C: 3E 08                             ld      a,08h   ; end address $07FF
003E: BC                                cp      h
003F: 78                                ld      a,b
0040: C2 39 00                          jp      nz,CRC_LOOP
0043: 2A 1E 00                          ld      hl,(CRCVALUE)
0046: 94                                sub     h
0047: 95                                sub     l
0048: CA 51 00                          jp      z,CRC_OK
004B: 21 77 03                          ld      hl,CRC_MESSAGE
004E: C3 A2 01                          jp      PRINTMSG_AND_HALT

                                 CRC_OK:
0051: 21 7E 03                          ld      hl,WELCOME_MESSAGE
0054: CD D6 00                          call    PRINTS_HL
...
00D3: 21 DA 17                          ld      hl,17DAh
                                        ; --- START PROC PRINTS_HL ---
00D6: E5                         PRINTS_HL: push    hl
00D7: 4E                                ld      c,(hl)
00D8: CD E3 00                          call    PUTCHAR
00DB: E1                                pop     hl
00DC: 23                                inc     hl
00DD: 7E                                ld      a,(hl)
00DE: B7                                or      a
00DF: C2 D6 00                          jp      nz,PRINTS_HL
00E2: C9                                ret

                                        ; --- START PROC PUTCHAR ---
                                        ; possible print character in C ?
00E3: 2A D6 17                   PUTCHAR: ld      hl,(17D6h)
00E6: EB                                ex      de,hl
...
019F: 21 8E 03                          PRINTSYSERR:
                                        ld      hl, SYSERR_MESSAGE

                                        PRINTMSG_AND_HALT:
01A2: CD D6 00                          call    PRINTS_HL
...
01B6: C8                                ret     z
01B7: FE 20                             cp      20h     ; ' '
01B9: DA 0E 02                          jp      c,CONTROL_CHARS
01BC: 71                                ld      (hl),c
01BD: E5                                push    hl
...
035C: 50                         L035C: DB      50h     ; 17D0
035D: 10                                DB      10h     ; 17D1
035E: E7                                DB      0E7h    ; 17D2
035F: 59                                DB      59h     ; 17D3
0360: 00                                DB      00h     ; 17D4
0361: 00                                DB      00h     ; 17D5
0362: 00                                DB      00h     ; 17D6
...
03B5: CD D6 00                          call    PRINTS_HL
                                        ; --- START PROC L03B8 ---
03B8: 21 F3 06                   L03B8: ld      hl,06F3h
03BB: CD D6 00                          call    PRINTS_HL
...
047D: 0C                                inc     c
047E: CD E3 00                   L047E: call    PUTCHAR
0481: F1                                pop     af
0482: D1                                pop     de
0483: 15                                dec     d
